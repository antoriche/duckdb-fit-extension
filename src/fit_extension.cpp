...
static void LoadInternal(DatabaseInstance &instance) {
	...
	ExtensionUtil::RegisterFunction(instance, fit_records_function);
	...
	ExtensionUtil::RegisterFunction(instance, fit_table_function);
	...
	ExtensionUtil::RegisterFunction(instance, fit_openssl_version_scalar_function);
}

void FitExtension::Load(DuckDB &db) {
...
DUCKDB_EXTENSION_API void fit_init(duckdb::DatabaseInstance &db) {
	duckdb::DuckDB db_wrapper(db);
	db_wrapper.LoadExtension<duckdb::FitExtension>();
}

DUCKDB_EXTENSION_API const char *fit_version() {
